...
The zoos want to display both the scientific name and the animal name in front of the habitats. Populate the displayNames array with only the animal_name and scientific_name of each animal. displayNames will be an array of strings, and each string should follow this
 pattern: "Name: Jackal, asiatic, Scientific: Canis aureus."

*/
const displayNames = [];
zooAnimals.forEach(a => displayNames.push('Name: '+a.animal_name+' '+a.scientific_name));
...
const lowCaseAnimalNames = zooAnimals.map(a => a.animal_name.toLocaleLowerCase());
